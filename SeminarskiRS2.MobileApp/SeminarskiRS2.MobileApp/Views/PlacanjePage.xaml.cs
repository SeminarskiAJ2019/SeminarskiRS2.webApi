...
namespace SeminarskiRS2.MobileApp.Views
{
    ...
    {
        public ViewModels.CreditCardVM CreditCardVM = null;
        ...
        public PlacanjePage(Utakmice utakmica, Sektori sektor, string OznakaSjedala, DateTime datum, Korisnik korisnik)
        {
            InitializeComponent();
            CreditCardVM = new ViewModels.CreditCardVM();
