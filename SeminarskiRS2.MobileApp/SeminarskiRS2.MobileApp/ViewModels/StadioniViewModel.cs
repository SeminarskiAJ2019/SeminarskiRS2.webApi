...
namespace SeminarskiRS2.MobileApp.ViewModels
{
    public class StadioniViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<Stadioni> StadioniList { get; set; } = new ObservableCollection<Stadioni>();
        ...
        public async Task Init()
        {
            ...
            if (SelectedGrad != null)//dolazimo ovdje kada korisnik odabere nesto u dropdown listi
            {
                ...
                var list = await _apiServiceStadioni.Get<IEnumerable<Stadioni>>(searchRequest);
                StadioniList.Clear();
